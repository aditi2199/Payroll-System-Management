...
void MENU :: MAIN_MENU(void)
{
    ...
    while (1)
    {
        ...
        gotoxy(5,23);
        cout<<"Email : p.aditi1899@gmail.com";
...
// THIS FUNCTION ADDS THE GIVEN DATA IN THE EMPLOYEES FILE
...
// THIS FUNCTION RETURNS THE LAST EMPLOYEES CODE
...
void EMPLOYEE :: SALARY_SLIP(void)
{
    ...
    L.BOX(2,1,79,25,219) ;
    gotoxy(31,2) ;
    cout <<"ADITI PATHAK, PGDBA - 200754667" ;
